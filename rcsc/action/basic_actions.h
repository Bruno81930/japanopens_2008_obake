...
/*!
  \file basic_actions.h
  \brief header collection of basic actions
*/
...
#ifndef RCSC_ACTION_BASIC_ACTIONS_H
#define RCSC_ACTION_BASIC_ACTIONS_H

#include <rcsc/action/arm_off.h>
