...
BasicSocket::open( const SocketType type )
{
    ...
    case BasicSocket::STREAM_TYPE:
        M_dest->socket_type = SOCK_STREAM;
        break;
    case BasicSocket::DATAGRAM_TYPE:
        M_dest->socket_type = SOCK_DGRAM;
        break;
    default:
    ...
    M_fd = ::socket( AF_INET, M_dest->socket_type, 0 );
#endif
                      ...
                      const int port )
{
    ...
    hints.ai_socktype = M_dest->socket_type;
    hints.ai_protocol = 0;
