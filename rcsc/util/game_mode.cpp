...
MapHolder::MapHolder()
{
    ...
    // M_playmode_map["foul_charge_l"]   = std::make_pair( GameMode::Foul_Charge_, LEFT );
    // M_playmode_map["foul_charge_r"]   = std::make_pair( GameMode::Foul_Charge_, RIGHT );
    ...
    // M_playmode_map["foul_ballout_l"]  = std::make_pair( GameMode::FoulBallOur_, LEFT );
    // M_playmode_map["foul_ballout_r"]  = std::make_pair( GameMode::FoulBallOur_, RIGHT );
...
*/
bool
GameMode::isOurSetPlay( const SideID ourside ) const
{
    switch ( type() ) {
    case KickOff_:
    case KickIn_:
