...
public:
    ...
    */
    ...
    public:
        ...
        typedef BPNetwork1< 2, 10, 2 > PosNet; // good
    ...
    public:
        ...
        */
        ...
        /*!
          ...
          \param type side type, if this is synmetry type, the refered param is used.
...
private:
    ...
    //! key: unum. but size is not always 11 if synmetric player exists.
