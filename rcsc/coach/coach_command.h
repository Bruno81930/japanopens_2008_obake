...
/*!
  ...
  \brief coach's connection command
...
public:
    /*!
      \breif constructor. nothing to do
     */
    CoachByeCommand()
      { }
...
public:
    /*!
      \breif construct with eye mode switch
...
/*!
  ...
  \brief coach's say command for CLang
...
public:
    /*!
      \breif construct with message string.
...
public:
    /*!
      \breif construct with xpm string and its coordinate.
...
public:
    /*!
      \breif construct with compression level
     */
    explicit
